...
const services = [
  {
    ...
    features: ['1 mover + van', 'From £100', 'Same-day available', 'Insured up to £10k'],
  },
  {
    id: 'flat',
    icon: Building2,
    ...
    features: ['2-3 movers + van', 'Lift/stairs assessment', 'Furniture disassembly', 'Insured up to £10k'],
  },
  {
    id: 'house',
    icon: Building,
    ...
    features: ['2-4 movers', 'Larger Luton vans', 'Packing service available', 'Insured up to £10k'],
  },
  {
    id: 'office',
    icon: Briefcase,
