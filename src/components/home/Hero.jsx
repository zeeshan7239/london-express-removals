...
import { Sparkles, Phone, Star, Shield, Clock, ChevronRight, Truck, Check } from 'lucide-react';
      ...
      <div className="container-wide relative pt-12 pb-20 lg:pt-20 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              <Sparkles className="w-3 h-3" /> Trusted by 10,000+ Londoners
            </motion.div>
            ...
            >
              Reliable man &amp; van service across London and the UK. Instant pricing,
              insured up to £10,000, and friendly movers who actually show up on time.
            </motion.p>
            ...
            >
              ...
              <a href={`tel:${siteConfig.phoneRaw}`} className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full bg-white/10 backdrop-blur border border-white/20 text-white font-semibold hover:bg-white/15 transition">
            ...
            >
              <span className="flex items-center gap-1.5 text-ink-200">
                <div className="flex">
                  {[1,2,3,4,5].map((s) => (
                    <Star key={s} className="w-3.5 h-3.5 fill-ember-400 text-ember-400" />
                  ))}
                </div>
                <span className="font-bold">4.9</span>
                <span className="text-ink-400">(2,400+ reviews)</span>
              </span>
              <span className="flex items-center gap-1.5 text-ink-300"><Shield className="w-3.5 h-3.5 text-emerald-400" /> Fully professionals</span>
