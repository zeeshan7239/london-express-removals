...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes — every move comes with goods-in-transit insurance covering up to £10,000 of belongings as standard. Higher cover available on request.',
  },
  {
    q: 'Do you charge extra for stairs or no lift?',
    a: 'There\'s a small surcharge for moves above the 2nd floor without a lift access. The exact figure depends on the team size and floor — you\'ll see this transparently on the booking page before you confirm.',
  },
  {
  ...
  {
    q: 'Do you go outside the M25?',
    a: 'Yes — for longer-distance UK moves, please request a custom quote. We come back with a tailored price within 30 minutes during business hours.',
  },
  {
    q: 'Do you provide packing materials?',
    a: 'On request, yes. We can supply boxes, tape, and bubble wrap, and we offer a full packing service if you\'d rather not pack yourself.',
  },
];

// Structured data for FAQ - boosts SEO with rich snippets
          ...
          {faqs.map((f, i) => (
            <div
              ...
              className={`rounded-2xl border-2 transition ${
                openIdx === i ? 'border-ember-500 bg-ember-50' : 'border-ink-100 bg-white hover:border-ink-200'
              }`}
            >
              <button
              ...
              >
                ...
                <div className={`w-7 h-7 rounded-full flex items-center justify-center transition ${
                  openIdx === i ? 'bg-ember-500 rotate-45' : 'bg-ink-100'
                }`}>
